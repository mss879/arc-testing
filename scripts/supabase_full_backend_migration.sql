-- ============================================================================
-- ARC AI — Complete Backend Migration
...
CREATE INDEX IF NOT EXISTS idx_contacts_email ON contacts_archive(email);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_email_subscriptions_email_topic 
...
DROP TRIGGER IF EXISTS update_contacts_archive_updated_at ON contacts_archive;
...
DROP TRIGGER IF EXISTS sync_lead_to_archive_trigger ON leads;
...
DROP TRIGGER IF EXISTS mark_lead_deleted_trigger ON leads;
...
-- Only seed if pipelines table is empty
DO $$
DECLARE
